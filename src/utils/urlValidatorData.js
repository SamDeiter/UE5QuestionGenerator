/**
 * URL Validator Data - Known valid Epic Games documentation slugs
 *
 * This file contains curated URL slugs for validation.
 * Separated from urlValidator.js for maintainability.
 */

// Known valid URL slugs (curated from actual documentation)
export const KNOWN_VALID_SLUGS = new Set([
  // Core Features
...
export const REQUIRES_SUFFIX_PATTERNS = [
  "nanite",
  "lumen",
  "niagara",
  "chaos",
