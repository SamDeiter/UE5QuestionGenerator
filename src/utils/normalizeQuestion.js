...
export const normalizeQuestion = (q, contextDefaults = {}) => {
  ...
  return {
    // Identity - always ensure these exist
    id: getValue('id', q.id),
    uniqueId: getValue('uniqueId', q.uniqueId),
    ...
    ...Object.fromEntries(
      Object.entries(q).filter(([key]) => 
        ![
          ...
          'id', 'uniqueId',
          // Content
          'discipline', 'difficulty', 'type', 'question', 'options', 'correct',
          // Metadata
          'status', 'language', 'creatorName', 'timestamp', 'dateAdded',
          // Source
          'sourceUrl', 'sourceExcerpt', 'tags', 'explanation',
          // Quality
          'qualityScore', 'critique', 'critiqueScore', 'suggestedRewrite', 'rewriteChanges',
          // Verification
          'sourceVerified', 'humanVerified', 'humanVerifiedBy',
          // Validation
          '_validation', 'answerMismatch', 'invalidUrl',
          // Rejection (expanded)
          'rejectionReason', 'rejectionCategory', 'rejectionNotes', 'rejectedAt', 'rejectedBy',
          // Duplicate tracking
          'isDuplicate', 'duplicateOf', 'similarityScore', 'duplicateCheckAt',
          // Quality issues
          'qualityIssues', 'flaggedForReview', 'flaggedReason', 'flaggedAt', 'flaggedBy',
          // Review
          'reviewStartedAt', 'reviewDuration', 'reviewerName', 'reviewCompletedAt',
          // Generation
          'estimatedCost', 'generationTime', 'model', 'groundingSources',
          // Variations
          'variations', 'originalMC',
          // Creator
          'creatorId', 'creatorEmail',
          // Firestore
          'firestoreUpdatedAt',
          // Analytics - Batch/Session
          'batchId', 'sessionId', 'generationIndex',
          // Analytics - Edit tracking
          'editCount', 'lastEditedAt', 'lastEditedBy', 'editHistory',
          // Analytics - View tracking
          'viewCount', 'firstViewedAt', 'lastViewedAt',
          // Analytics - Acceptance
          'acceptedAt', 'acceptedBy', 'kickedBackAt', 'kickedBackBy', 'kickedBackReason',
          // Analytics - Rewrite
          'wasRewritten', 'rewriteAppliedAt', 'originalQuestionText',
          // Analytics - Export
          'exportedAt', 'exportedTo', 'exportCount'
        ].includes(key)
      )
    ),
  };
