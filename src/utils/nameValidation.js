...
/**
 * Quick check if a name is valid (returns boolean only).
 * Use validateDisplayName() for detailed error messages.
 *
...
/**
 * Sanitizes a name by applying normalization without full validation.
 * Useful for cleaning up user input before display.
 *
...
export const sanitizeName = (name) => {
  ...
  return String(name)
    ...
    .slice(0, NAME_LIMITS.MAX_LENGTH); // Truncate if too long
};
 ...
 * @returns {string} - First name or original if no space found
 */
