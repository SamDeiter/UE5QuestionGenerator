...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | Graphics | Multiple Choice | Medium | What is the primary rendering pipeline in Unreal Engine 5? | | Forward Rendering | Deferred Rendering | Nanite | Lumen | B | https://dev.epicgames.com/documentation/en-us/unreal-engine/nanite-virtualized-geometry-in-unreal-engine | Unreal Engine 5 uses deferred rendering by default to handle dynamic lighting efficiently. |`,
  },
...
| 1 | Graphics | Multiple Choice | Medium | 虚幻引擎5中的主要渲染管线是什么？ | | 前向渲染 | 延迟渲染 | Nanite | Lumen | B | https://dev.epicgames.com/documentation/en-us/unreal-engine/nanite-virtualized-geometry-in-unreal-engine | Unreal Engine 5 uses deferred rendering by default to handle dynamic lighting efficiently. |`,
  ...
  explanation: {
    text: () =>
      `Deferred Rendering is the primary pipeline in UE5 because it allows for efficient handling of multiple lights and complex materials. The G-Buffer stores geometric information that can be processed in screen space.`,
  },
