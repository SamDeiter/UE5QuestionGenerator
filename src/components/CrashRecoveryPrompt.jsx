        ...
        <div className="p-6 space-y-4">
          <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-700/50">
            <p className="text-sm text-slate-300 mb-3">
              <strong className="text-blue-300">Good news!</strong> We found a
              cloud backup of your questions.
            </p>

            <div className="grid grid-cols-2 gap-4 text-center">
              <div className="bg-slate-800/50 p-3 rounded-lg">
                <p className="text-2xl font-bold text-blue-400">
                  {recoveryData.firestoreCount}
                </p>
                <p className="text-xs text-slate-500">In Cloud Backup</p>
              </div>
              <div className="bg-slate-800/50 p-3 rounded-lg">
                <p className="text-2xl font-bold text-slate-400">
                  {recoveryData.localCount}
                </p>
          ...
          <p className="text-xs text-slate-400 text-center">
            ...
            <br />
            Your questions were automatically backed up to Firestore.
          </p>
          ...
          {isRecovering && (
            <div className="bg-slate-800/50 p-4 rounded-lg border border-blue-700/50">
              ...
              <div className="relative w-full h-2 bg-slate-700 rounded-full overflow-hidden">
                <div
                  className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-500 animate-pulse rounded-full"
                  style={{
              ...
              <p className="text-xs text-slate-500 mt-2 text-center">
                Restoring {recoveryData.firestoreCount} questions...
              </p>
              <style>{`
