            ...
            {reviewerAnalytics && (
              <>
                      ...
                      {reviewerAnalytics.reviewerStats.length === 0 ? (
                        ...
                        reviewerAnalytics.reviewerStats.map((reviewer, idx) => (
                          ...
                          >
                            ...
                            <td className="p-2 text-center text-slate-300">
                              {formatDuration(
                                reviewer.averageReviewTimeSeconds
                              )}
                            </td>
                            <td className="p-2 text-center text-slate-300">
                ...
                <button
                  onClick={loadReviewerAnalytics}
                  disabled={analyticsLoading}
                  className="w-full bg-slate-700 hover:bg-slate-600 disabled:bg-slate-800 disabled:cursor-not-allowed text-white px-3 py-2 rounded text-sm transition-all flex items-center justify-center gap-2 mt-3"
                >
                  {analyticsLoading ? (
                    <>
