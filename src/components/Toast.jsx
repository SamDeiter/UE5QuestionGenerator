...
const Toast = ({
  ...
  const bgColors = {
    success: cb
      ? "bg-blue-900/95 border-blue-500/50 shadow-blue-900/20"
      : "bg-emerald-900/95 border-emerald-500/50 shadow-emerald-900/20",
    error: cb
      ? "bg-rose-950/95 border-rose-500/50 shadow-rose-900/20"
      : "bg-red-950/95 border-red-500/50 shadow-red-900/20",
  ...
  const progressColors = {
    success: cb ? "bg-blue-500" : "bg-emerald-500",
    error: cb ? "bg-rose-500" : "bg-red-500",
