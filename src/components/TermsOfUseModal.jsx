    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-slate-900 border border-yellow-500 w-full max-w-4xl max-h-[90vh] rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto max-h-[60vh] space-y-6 text-slate-200">
          ...
          <section className="bg-red-900/20 border border-red-700 rounded-lg p-4">
            ...
            <p className="text-sm leading-relaxed">
              This tool is provided <strong>"AS IS"</strong> for educational
              purposes only. Epic Games, Inc. and the tool creator make{" "}
              <strong>NO WARRANTIES</strong> about the accuracy, completeness,
              reliability, or suitability of AI-generated content.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="text-sm space-y-2 list-disc list-inside">
              <li>
                You are <strong>solely responsible</strong> for reviewing all
                AI-generated questions
              </li>
              <li>
                You must verify <strong>technical accuracy</strong> before using
                in assessments
              </li>
              <li>
                You accept <strong>full liability</strong> for any content you
                approve and deploy
              </li>
              <li>
                Epic Games is NOT responsible for errors in AI-generated content
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed">
              Questions are generated by <strong>Google Gemini AI</strong> and
              may contain:
            </p>
          ...
          <section>
            ...
            <p className="text-xs leading-relaxed bg-slate-800 p-3 rounded">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, EPIC GAMES, INC. AND THE
              TOOL CREATOR SHALL NOT BE LIABLE FOR ANY DIRECT, INDIRECT,
              INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR EXEMPLARY DAMAGES ARISING
              FROM USE OF THIS TOOL, INCLUDING BUT NOT LIMITED TO: DAMAGES FOR
              LOSS OF DATA, INACCURATE ASSESSMENTS, STUDENT DISPUTES, OR ANY
              OTHER MATTER RELATING TO THE USE OF AI-GENERATED CONTENT.
            </p>
          </section>

          {/* Authorized Users Only */}
          <section>
            <h3 className={`text-lg font-bold ${successHeading} mb-3`}>
              Authorized Users
            </h3>
            <p className="text-sm">
              This tool is intended for{" "}
              <strong>Unreal Engine Authorized Instructors</strong> only. By
              using this tool, you represent that you are:
            </p>
            <ul className="text-sm space-y-1 list-disc list-inside mt-2">
              <li>At least 18 years of age</li>
              <li>A certified Unreal Engine instructor or educator</li>
              <li>
                Authorized to create educational content for Unreal Engine
                training
              </li>
              <li>
                Compliant with Epic Games' Authorized Instructor Program terms
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-800 border border-slate-600 rounded-lg p-4 mt-6">
            ...
            <ul className="text-xs space-y-1 mt-2">
              ...
              <li>
                ✓ Epic Games' Privacy Policy and Data Processing practices
              </li>
            </ul>
          </section>
        </div>
        ...
        <div className="bg-slate-800 border-t border-slate-700 p-6 flex justify-between items-center">
          ...
          <button
            onClick={onAccept}
            className={`px-8 py-3 ${successBtnClasses} text-white font-bold rounded-lg transition-colors shadow-lg`}
          >
