...
const LandingPage = ({
  ...
  const successDot = cb ? "bg-blue-500" : "bg-green-500";
  const successText = cb ? "text-blue-400" : "text-green-400";
  const errorDot = cb ? "bg-rose-500" : "bg-red-500";
      ...
      <div className="z-10 text-center space-y-8 max-w-2xl animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center w-full">
          ...
          >
            ...
            <p className="text-xs text-slate-400 text-center">
              Manage existing database, approve/reject questions, and bulk
              export.
            </p>
          </Card>
        ...
        <div className="flex items-center justify-center gap-6 text-xs text-slate-500 font-mono pt-8">
          ...
          {(() => {
            ...
            return (
              <div className={`px-2 py-0.5 rounded border ${envBorderBg}`}>
