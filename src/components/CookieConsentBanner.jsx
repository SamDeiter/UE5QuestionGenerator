...
const CookieConsentBanner = () => {
  ...
  const successHeading = cb ? "text-blue-400" : "text-green-400";
      ...
      <div className="max-w-6xl mx-auto bg-slate-900 border-2 border-blue-500 rounded-xl shadow-2xl overflow-hidden">
        <div className="p-6">
          ...
          <div className="text-sm text-slate-300 space-y-3 mb-6">
            <p>
              This tool uses <strong>cookies and localStorage</strong> to
              provide functionality and improve your experience.
            </p>

            <div className="grid md:grid-cols-2 gap-4 text-xs">
              <div className="bg-slate-800 p-3 rounded-lg">
                <h4 className={`font-semibold ${successHeading} mb-2`}>
            ...
            <p className="text-xs text-slate-500">
              <strong>GDPR Rights:</strong> You can change your preferences
              anytime in Settings. Data is stored in Google Firebase (USA). See
              our{" "}
              <a
