...
const AgeGateModal = ({ isOpen, onConfirm, onExit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (age >= 18) {
      ...
      alert(
        "This tool is restricted to users 18 years and older. You will be redirected."
      );
      onExit();
    }
  };
        ...
        <div className="p-6 space-y-4">
          <div className="bg-yellow-900/30 border border-yellow-700 rounded-lg p-4 flex gap-3">
            ...
            <div className="text-sm text-yellow-200">
              ...
              <p>
                This tool is intended for professional educators and Unreal
                Engine Authorized Instructors only.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-xs text-slate-500 text-center">
              By continuing, you confirm you are 18+ years of age and accept the
              Terms of Use.
            </p>
