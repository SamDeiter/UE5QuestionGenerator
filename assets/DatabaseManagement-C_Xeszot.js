const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BgOrAPK0.js","assets/ui-components-C7Nwk7Wk.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-DJesxG0r.js","assets/agents-logic-DkpRB--7.js","assets/vendor-firebase-DI6Ofeub.js","assets/vendor-charts-B13_Qk3l.js","assets/index-VLmSftEE.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,_ as c,af as u,am as m}from"./ui-components-C7Nwk7Wk.js";import"./vendor-icons-DJesxG0r.js";import{C as f}from"./index-BgOrAPK0.js";import{l as o}from"./agents-logic-DkpRB--7.js";import"./vendor-react-C5vGbBff.js";import"./vendor-firebase-DI6Ofeub.js";import"./vendor-charts-B13_Qk3l.js";const E=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(f,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-BgOrAPK0.js").then(d=>d.j);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
