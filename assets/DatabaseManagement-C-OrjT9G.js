const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-C2HG4p7s.js","assets/ui-components-BGihuteg.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-B3829RNE.js","assets/agents-logic-CTAnqVEG.js","assets/vendor-firebase-CICfsCOk.js","assets/vendor-charts-D2au_eiQ.js","assets/index-DWGmMHQ8.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,a0 as c,an as u,ax as m}from"./ui-components-BGihuteg.js";import"./vendor-icons-B3829RNE.js";import{C as f}from"./index-C2HG4p7s.js";import{l as o}from"./agents-logic-CTAnqVEG.js";import"./vendor-react-C5vGbBff.js";import"./vendor-firebase-CICfsCOk.js";import"./vendor-charts-D2au_eiQ.js";const E=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(f,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-C2HG4p7s.js").then(d=>d.k);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
