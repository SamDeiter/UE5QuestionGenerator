const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BzWFnx2a.js","assets/ui-components-BxXtPuP8.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-DJesxG0r.js","assets/agents-logic-lA0DTGPN.js","assets/vendor-firebase-DoEDPRtH.js","assets/vendor-charts-Cxanh-16.js","assets/index-CAV5kUQ2.css"])))=>i.map(i=>d[i]);
import{j as t,I as i,_ as d,$ as c,a3 as u}from"./ui-components-BxXtPuP8.js";import"./vendor-icons-DJesxG0r.js";import{C as m}from"./index-BzWFnx2a.js";import"./vendor-react-C5vGbBff.js";import"./agents-logic-lA0DTGPN.js";import"./vendor-firebase-DoEDPRtH.js";import"./vendor-charts-Cxanh-16.js";const T=({showMessage:e,isCollapsed:s,onToggle:o})=>t.jsxs(m,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:o,variant:"red",children:[t.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),t.jsxs("div",{className:"space-y-3",children:[t.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:n}=await d(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-BzWFnx2a.js").then(l=>l.i);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7])),r=await n();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
