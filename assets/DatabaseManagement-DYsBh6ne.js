const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CtaaI2b_.js","assets/ui-components-C92xn2zv.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-B82Zic7t.js","assets/agents-logic-Dl98d14p.js","assets/vendor-firebase-v9PRsiIa.js","assets/vendor-charts-DC1yPgez.js","assets/index-BqC7F4fQ.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,_ as c,ah as u,ar as m}from"./ui-components-C92xn2zv.js";import"./vendor-icons-B82Zic7t.js";import{C as f}from"./index-CtaaI2b_.js";import{l as o}from"./agents-logic-Dl98d14p.js";import"./vendor-react-C5vGbBff.js";import"./vendor-firebase-v9PRsiIa.js";import"./vendor-charts-DC1yPgez.js";const E=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(f,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-CtaaI2b_.js").then(d=>d.k);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
