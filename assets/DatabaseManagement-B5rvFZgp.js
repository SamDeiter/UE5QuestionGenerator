const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DTgNJjWc.js","assets/ui-core-DTuqVtnI.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-B3829RNE.js","assets/vendor-charts-CW6gOjuq.js","assets/agents-logic-DvaonP58.js","assets/vendor-firebase-CRri6-fV.js","assets/ui-router-BVVRn2IC.js","assets/index-DjNSFrNY.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,_ as c,ae as u,av as m}from"./ui-core-DTuqVtnI.js";import"./vendor-icons-B3829RNE.js";import{C as p}from"./index-DTgNJjWc.js";import{l as o}from"./agents-logic-DvaonP58.js";import"./vendor-react-C5vGbBff.js";import"./vendor-charts-CW6gOjuq.js";import"./vendor-firebase-CRri6-fV.js";import"./ui-router-BVVRn2IC.js";const j=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(p,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-DTgNJjWc.js").then(d=>d.k);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7,8])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
