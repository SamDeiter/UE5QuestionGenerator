const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DUl439tA.js","assets/ui-core-D-Vee7Hi.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-FQnf4AFT.js","assets/vendor-charts-Cg6M_0k3.js","assets/agents-logic-D04BUpDH.js","assets/vendor-firebase-Qv4tLCGo.js","assets/ui-router-Dag1cNwB.js","assets/index-3WbzLr-s.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,_ as c,ac as u,at as m}from"./ui-core-D-Vee7Hi.js";import"./vendor-icons-FQnf4AFT.js";import{C as p}from"./index-DUl439tA.js";import{l as o}from"./agents-logic-D04BUpDH.js";import"./vendor-react-C5vGbBff.js";import"./vendor-charts-Cg6M_0k3.js";import"./vendor-firebase-Qv4tLCGo.js";import"./ui-router-Dag1cNwB.js";const j=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(p,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-DUl439tA.js").then(d=>d.k);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7,8])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
