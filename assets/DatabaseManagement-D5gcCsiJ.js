const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-ySko1L99.js","assets/ui-components-BIIDcw8k.js","assets/vendor-react-C5vGbBff.js","assets/vendor-icons-DJesxG0r.js","assets/agents-logic-BV6Qp_uk.js","assets/vendor-firebase-CJQmPlzu.js","assets/vendor-charts-B13_Qk3l.js","assets/index-bcTQAyjk.css"])))=>i.map(i=>d[i]);
import{j as n,I as i,_ as c,ae as u,al as m}from"./ui-components-BIIDcw8k.js";import"./vendor-icons-DJesxG0r.js";import{C as f}from"./index-ySko1L99.js";import{l as o}from"./agents-logic-BV6Qp_uk.js";import"./vendor-react-C5vGbBff.js";import"./vendor-firebase-CJQmPlzu.js";import"./vendor-charts-B13_Qk3l.js";const E=({showMessage:e,isCollapsed:s,onToggle:l})=>n.jsxs(f,{title:"Database Management",icon:"database",isCollapsed:s,onToggle:l,variant:"red",children:[n.jsx("p",{className:"text-xs text-slate-400 mb-4",children:"⚠️ Danger Zone: These operations permanently delete data and cannot be undone."}),n.jsxs("div",{className:"space-y-3",children:[n.jsxs("button",{onClick:async()=>{if(confirm(`🔗 Link Existing Translations?
...
Proceed?`))try{e("🔄 Starting translation migration...",1e4);const{migrateTranslationsViaCloudFunction:t}=await c(async()=>{const{migrateTranslationsViaCloudFunction:a}=await import("./index-ySko1L99.js").then(d=>d.i);return{migrateTranslationsViaCloudFunction:a}},__vite__mapDeps([0,1,2,3,4,5,6,7])),r=await t();if(r.success){const{stats:a}=r;e(`✅ Migration complete!
