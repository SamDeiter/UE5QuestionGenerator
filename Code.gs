// v1.7 - Multi-Language Master DB with Unique ID
const HEADERS = ['ID', 'Unique ID', 'Status', 'Discipline', 'Difficulty', 'Question Type', 'Question', 'Option A', 'Option B', 'Option C', 'Option D', 'Answer', 'Explanation', 'Language', 'SourceFile', 'LastUpdated'];
...
function doPost(e) {
  ...
  try {
    ...
    // Filename: UE5_English_MC_Easy_2025-11-27_10-30
